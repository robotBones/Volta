...
describe('Project API:', function() {
  ...
  describe('POST /api/projects', function() {
    beforeEach(function(done) {
      request(app)
        ...
        .send({
          title: 'New Project',
          subheading: 'This is the brand new project!!!'
        })
        .expect(201)
        .expect('Content-Type', /json/)
        .end(function(err, res) {
    ...
    it('should respond with the newly created project', function() {
      ...
      newProject.subheading.should.equal('This is the brand new project!!!');
    });
  ...
  describe('GET /api/projects/:id', function() {
    ...
    it('should respond with the requested project', function() {
      ...
      project.subheading.should.equal('This is the brand new project!!!');
    });
  ...
  describe('PUT /api/projects/:id', function() {
    ...
    beforeEach(function(done) {
      request(app)
        ...
        .send({
          ...
          subheading: 'This is the updated project!!!'
        })
        .expect(200)
        .expect('Content-Type', /json/)
        .end(function(err, res) {
    ...
    it('should respond with the updated project', function() {
      ...
      updatedProject.subheading.should.equal('This is the updated project!!!');
    });
