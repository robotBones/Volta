		...
		19: [function (_dereq_, module, exports) {
			...
			Picker = (function () {
				...
				Picker.prototype.buildItem = function (picker, option, index) {
					...
					var theValue = option.getAttribute('value');
					console.log(option.getAttribute('value'));
					if (theValue === 'left') {
						dom(item).addClass('vi-alignment-left');
					} else if (theValue === 'right') {
						dom(item).addClass('vi-alignment-right');
					} else if (theValue === 'center') {
						dom(item).addClass('vi-alignment-center');
					} else if (theValue === 'justify') {
						dom(item).addClass('vi-alignment-justified');
					}
